...
SECRET_KEY = 'wq4##n+9m9o*4+mm7@x8gz6j%$s&+dcr&-4jn3w41*#5=*tc28'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'Notification.context_processor.pass_value'
            ],
        },
    },
]

WSGI_APPLICATION = 'toob.wsgi.application'
